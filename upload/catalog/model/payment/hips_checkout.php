...
class ModelPaymentHipsCheckout extends Model
{
    ...
    public function addShipping($hips_checkout_order, $order)
    {
        ...
        $query1 = $this->db->query("SELECT order_id, code, title,text, value from " . DB_PREFIX . "order_total WHERE order_id ='" . $hips_checkout_order . "'");
        ...
        foreach ($query1->rows as $row) {
            ...
            if ($row['code'] == 'total') {
                ...
                $this->db->query("UPDATE " . DB_PREFIX . "order_total SET value = '" . $total . "' , text  = '" . $total . "' WHERE order_id ='" . $hips_checkout_order . "' and code='total'");
        ...
        if ($query2->num_rows > 0) {
            ...
            $query = $this->db->query("UPDATE " . DB_PREFIX . "order_total SET title = '" . $shipping_name . "', text = '" . $shipping_fee . "', value = '" . $shipping_fee . "', sort_order = '3' 
                    WHERE order_id ='" . $hips_checkout_order . "' and code='shipping'");
            
        }
        
        else {
            $query = $this->db->query("INSERT INTO " . DB_PREFIX . "order_total SET order_id = '" . $hips_checkout_order . "', code = 'shipping', title = '" . $shipping_name . "', text = '" . $shipping_fee . "', value = '" . $shipping_fee . "', sort_order = '3'");
        }
    }
}